...
const seedData = async () => {
    const AppDataSource = new typeorm_1.DataSource({
        ...
        entities: [travel_entities_1.Travel],
        synchronize: true,
    });
    await AppDataSource.initialize();
    const travelRepository = AppDataSource.getRepository(travel_entities_1.Travel);
    const travels = [
        {
        ...
        },
        {
            ...
            description: 'Thailand-Border: from Cambodia to beautiful island border...',
            startingDate: '2025-11-01',
            endingDate: '2025-11-09',
            price: 199900,
            maxCapacity: 5,
        ...
        },
        {
            ...
            slug: 'Vietnam-South',
            name: 'Vietnam South',
            description: 'Vietnam South: from Ho-Chi-Min city (Saigon) to Phu Quoc island',
            startingDate: '2025-11-01',
            endingDate: '2025-11-09',
            price: 199900,
            maxCapacity: 5,
